  ...
  return new Promise((resolve, reject) => {
    setTimeout(function () {
      if (Math.random() >= failProb) {
        logger.log(this, 'getFakeData: resolving', {
...
export default class FakeDataLoader extends Component {
  ...
  render() {
    return (
      <div>
        <Row>
          Fake Data Loader: For any change of parameter, data alternates between
          precip 1990-1 and 1990-2
        </Row>
        <Row>
          <Col lg={6}>
            ...
            <input
              ...
              onChange={event => {
                ...
                // Alternatively, could call this.loadData() in
                // componentDidUpdate(), but would have to compare old state to
                // new ... and we know what's happening here.
              }}
            />
          </Col>
          <Col lg={6}>
